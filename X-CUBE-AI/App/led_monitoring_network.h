...
#ifndef __AI_LED_MONITORING_NETWORK_H__
#define __AI_LED_MONITORING_NETWORK_H__
#pragma once

#include "ai_platform.h"

#define AI_LED_MONITORING_NETWORK_MODEL_NAME          "led_monitoring_network"

#define AI_LED_MONITORING_NETWORK_IN_NUM       (1)
#define AI_LED_MONITORING_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 2, 1, NULL), \
}
#define AI_LED_MONITORING_NETWORK_IN_SIZE { \
  (1 * 1 * 2), \
}
#define AI_LED_MONITORING_NETWORK_IN_1_SIZE  (1 * 1 * 2)
#define AI_LED_MONITORING_NETWORK_IN_1_SIZE_BYTES  ((1 * 1 * 2) * 4)




#define AI_LED_MONITORING_NETWORK_OUT_NUM      (1)
#define AI_LED_MONITORING_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 3, 1, NULL), \
}
#define AI_LED_MONITORING_NETWORK_OUT_SIZE { \
  (1 * 1 * 3), \
}
#define AI_LED_MONITORING_NETWORK_OUT_1_SIZE  (1 * 1 * 3)
#define AI_LED_MONITORING_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 3) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup led_monitoring_network
 ...
 * @ingroup led_monitoring_network
 ...
 * @ref ai_led_monitoring_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_led_monitoring_network_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_LED_MONITORING_NETWORK_*
 * defines into file @ref led_monitoring_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_led_monitoring_network_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_LED_MONITORING_NETWORK_H__*/
